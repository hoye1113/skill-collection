...
**Dispatch via Kimi `Agent`**:
```
subagent_type: "plan"
description: "Continuity review"
prompt: "You are a continuity editor for creative writing. Your job is to verify
...
Use the task inputs below; do not assume parent-agent context."
```
...
prompt: "You are a style editor for creative writing. You check prose quality,
...
prompt: "You are a structural editor. You read the complete work and assess
pacing, transitions, arc completeness, and balance. Output: PASS or FAIL
with specific issues and locations. Use the task inputs below; do not assume
