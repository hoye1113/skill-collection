...
Citation consolidation is not a review sub-agent — footnote definitions are
deduplicated by URL during assembly (see citation.md).
...
4. **Citation quality**: Are key claims backed by `[^id]` footnote citations with inline definitions? Are sources T1/T2? Flag uncited statistics and vague attributions ("studies show...").
