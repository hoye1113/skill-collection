...
| | [web-video-presentation](ai-generation/web-video-presentation/) | 文章转"伪视频"网页演示（可选 TTS） |
| | [image-generation](ai-generation/image-generation/) | Gemini/fal.ai 生图 + Grok/fal.ai 生视频（双 provider） |
...
| 仓库 | 说明 |
|------|------|
| [hoye-skills-main](https://github.com/) | 主技能库 |
| [sanyuan-skills](https://github.com/) | 三元技能集 |
| [garden-skills](https://github.com/) | Garden 技能集 |
